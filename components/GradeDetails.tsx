...
import { bnccCurriculumLabel, bnccDisciplineRefLabel, bnccSkillDescription, bnccTeachingStageLabel } from '../utils/bnccDisplay';
                                                            ...
                                                            bncc && (
                                                                <div key={bncc.id} className="group/bncc relative">
                                                                    ...
                                                                    <div className="absolute z-20 hidden group-hover/bncc:block w-72 p-3 bg-slate-800 dark:bg-slate-900 text-white text-xs rounded-lg shadow-xl -top-2 left-full ml-2">
                                                                        ...
                                                                        {bnccTeachingStageLabel(bncc) && <div className="text-slate-400 mb-1">{bnccTeachingStageLabel(bncc)}</div>}
                                                                        <p className="line-clamp-4">{bnccSkillDescription(bncc) || '—'}</p>
                                                                        {bnccDisciplineRefLabel(bncc) && (
                                                                            <div className="mt-2 pt-2 border-t border-slate-600 text-slate-400">
                                                                                <span className="font-medium">Disciplina:</span> {bnccDisciplineRefLabel(bncc)}
                                                                            </div>
                                                                        )}
                                                                    </div>
                                                                </div>
