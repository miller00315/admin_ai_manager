...
export default defineConfig(({ mode }) => {
    ...
    return {
      ...
      define: {
        ...
        'import.meta.env.REACT_APP_SUPABASE_URL': JSON.stringify(env.REACT_APP_SUPABASE_URL || env.VITE_SUPABASE_URL),
        'import.meta.env.REACT_APP_SUPABASE_ANON_KEY': JSON.stringify(env.REACT_APP_SUPABASE_ANON_KEY || env.VITE_SUPABASE_ANON_KEY),
      },
      build: {
        target: 'es2022',
        commonjsOptions: {
