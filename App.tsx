...
const App: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (hasCredentials) {
            ...
            // If client is null but we have credentials in localStorage, 
    ...
    if (session && !authLoading && userRole !== 'Administrator') {
        return (
            <div className="h-screen w-screen flex flex-col items-center justify-center bg-slate-50 p-4">
                <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full border border-red-200">
                    <div className="flex flex-col items-center mb-6">
                        ...
                        <p className="text-slate-600 text-center text-sm">
                            Esta aplicação é exclusiva para Administradores. Por favor, acesse a aplicação correta para seu perfil.
                        </p>
                    </div>
                </div>
            </div>
